...
@Component({
  selector: 'lv-badge-history',
  templateUrl: './badge-history.component.html',
  styleUrls: ['./badge-history.component.scss']
})
export class BadgeHistoryComponent extends Pagination implements OnInit, OnDestroy {
  ...
  public readonly heading = [ 
    ...
    { heading: 'description', key: 'description', align: 'center' }
  ];
  ...
  finallyGetAudiltLog() {
    let queryObj = {
      auditLogType:  this.API_EVENT.badgeHistory,
      userId: this.userId,
