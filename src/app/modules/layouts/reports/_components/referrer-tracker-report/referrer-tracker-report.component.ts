...
import {  REFERRER_TRACK_REPORT_API,  } from 'src/app/constants/api-end-point';
import {  BC_REFERRER_REPORT_LIST } from 'src/app/constants/breadcrumb-routes';
...
import { REFERRER, REPORTS } from 'src/app/constants/routes';
import { CommonService } from 'src/app/services/common/common.service';
import { StorageService } from 'src/app/services/storage/storage.service';
import { SelesTrackerService } from '../../../seles-tracker/_services/seles-tracker.service';

@Component({
  selector: 'lv-referrer-tracker-report',
  templateUrl: './referrer-tracker-report.component.html',
  styleUrls: ['./referrer-tracker-report.component.scss'],
  providers: [SelesTrackerService]
})
export class ReferrerTrackerReportComponent extends Pagination implements OnInit {

  public heading = [
    { heading: 'Referrer UID', key: 'referrerId', align: 'center' },
    { heading: "Referrer Client Code", key: "referrerClientCode",align: 'center',  },
    { heading: "Referrent Name", key: "referrentFirstName", align: "center" },
    { heading: "Referrent Registered", key: "referrentRegistered", align: "center" },
    { heading: "Referrent Last Active", key: "referrentActiveUpto", align: "center" },
    { heading: "Referrent Active InDays", key: "referrentActiveInDays", align: "center" }
  ];
  ...
  ngOnInit() {
    this._bc.setBreadcrumb(BC_REFERRER_REPORT_LIST());
    this.createForm();
    this.filterOnload();
  ...
  public getSalesTrackList(): void {
    ...
    this._seles_tracker.getReferrerTrackList(queryObj).subscribe(response => {
  ...
  private  updateQueryParams(updatedQueryParams = {}) {
    this._router.navigate([`${REPORTS}/${REFERRER}`], { queryParams: updatedQueryParams });
  }
  ...
  downloadList(event) {
    ...
    this._common.exportReports(REFERRER_TRACK_REPORT_API, obj);
  }
